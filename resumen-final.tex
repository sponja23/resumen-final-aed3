...
\begin{theorem*}
    Dada una red de flujo $N = (V, E, u)$ junto con un flujo factible $x$, si $P$ es un camino entre $s$ y $t$ en la red residual $R(N, x)$, se puede definir un nuevo flujo $\bar{x}$:
        ...
        \begin{cases}
            x(v \rightarrow w) + \Delta(P) & \si v \rightarrow w \in E \\
            x(v \rightarrow w) - \Delta(P) & \si w \rightarrow v \in E \\
            x(v \rightarrow w) & \ecc
        \end{cases}
        $$
...
\begin{proof}
    ...
    x_k(v \rightarrow w) =
    \begin{cases}
        x_{k - 1}(v \rightarrow w) + \Delta(P) & \si v \rightarrow w \in E \\
        x_{k - 1}(v \rightarrow w) - \Delta(P) & \si w \rightarrow v \in E \\
...
\begin{problema}
    ...
    \begin{itemize}
        ...
        \item Respeta las capacidades de las aristas $e \in E$:
            $$0 \leq x(e) \leq u(e)$$
        \item Tiene costo $C = \sum_{e \in E} c(e) \cdot x(e)$ es mínimo.
    \end{itemize}
\end{problema}
